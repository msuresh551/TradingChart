    ...
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void ddlscript_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                int i = 0;
                bool read = false;
                string url = "http://finance.google.com/finance/getprices?q=" + ddlscript.SelectedValue.Trim() + "&x=NSE&i=1800&p=1d&f=o&df=cpct&auto=1&ts=1266701290218";
                ...
                //closing
                url = "http://finance.google.com/finance/getprices?q=" + ddlscript.SelectedValue.Trim() + "&x=NSE&i=1800&p=1d&f=c&df=cpct&auto=1&ts=1266701290218";
